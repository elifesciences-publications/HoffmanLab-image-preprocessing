function I2 = lensdistort(I, k, ex, a1, a2, a3, varargin)
...
% Nested function that perfoms the transformation
    ...
    s = distortfun(r,k,ex,a1,a2,a3,p.Results.ftype);
    % un-normalize s
    s2 = s * R;
...
% Nested function that pics the model type to be used
    function s = distortfun(r,k,ex,a1,a2,a3,fcnum)
        switch fcnum
            case(1)
                s = r.*(1./(1+k.*r));
            case(2)
